...
// /___/   /\     Timestamp : 01/31/2026 02:34:48
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w C:/EE533/Lab3_Mini_IDS/Schematic/dropfifo.sch dropfifo.vf
...
module dropfifo(clk, 
   ...
   OR2 XLXI_7 (.I0(XLXN_24), 
               .I1(XLXN_23), 
               .O(XLXN_25));
   AND2B1 XLXI_8 (.I0(XLXN_58), 
                  .I1(XLXN_25), 
                  .O(XLXN_53));
   FD8CE_MXILINX_dropfifo XLXI_9 (.C(clk), 
                                  .CE(XLXN_53), 
                                  .CLR(rst), 
                                  .D(waddr[7:0]), 
                                  .Q(XLXN_56[7:0]));
   // synthesis attribute HU_SET of XLXI_9 is "XLXI_9_17"
   FD XLXI_10 (.C(clk), 
               .D(drop_pkt), 
               .Q(XLXN_58));
   defparam XLXI_10.INIT = 1'b0;
   COMP8_MXILINX_dropfifo XLXI_11 (.A(waddr[7:0]), 
                                   .B(raddr[7:0]), 
                                   .EQ(XLXN_47));
   // synthesis attribute HU_SET of XLXI_11 is "XLXI_11_18"
   COMP8_MXILINX_dropfifo XLXI_12 (.A(raddr[7:0]), 
                                   .B(XLXN_56[7:0]), 
                                   .EQ(XLXN_46));
   // synthesis attribute HU_SET of XLXI_12 is "XLXI_12_19"
   AND3B2 XLXI_15 (.I0(XLXN_46), 
                   .I1(XLXN_47), 
                   .I2(fiforead), 
                   .O(XLXN_74));
   CB8CLE_MXILINX_dropfifo XLXI_16 (.C(clk), 
                                    .CE(XLXN_75), 
                                    .CLR(rst), 
                                    .D(XLXN_56[7:0]), 
                                    .L(XLXN_58), 
                                    ...
                                    .Q(waddr[7:0]), 
                                    .TC());
   // synthesis attribute HU_SET of XLXI_16 is "XLXI_16_20"
   CB8CE_MXILINX_dropfifo XLXI_17 (.C(clk), 
                                   .CE(XLXN_74), 
                                   .CLR(rst), 
                                   .CEO(), 
                                   .Q(raddr[7:0]), 
                                   .TC());
   // synthesis attribute HU_SET of XLXI_17 is "XLXI_17_21"
   FDC XLXI_18 (.C(clk), 
                .CLR(rst), 
                .D(XLXN_74), 
                .Q(valid_data));
   defparam XLXI_18.INIT = 1'b0;
   VCC XLXI_20 (.P(XLXN_70));
   sync_dual_port_mem XLXI_27 (.addra(waddr[7:0]), 
                               .addrb(raddr[7:0]), 
                               .clka(clk), 
                               .clkb(clk), 
                               .dina(XLXN_77[71:0]), 
